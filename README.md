...
"**NeKoRoSYS's NecroDots**" aims to provide a clean and reliable generic modular framework that lets you easily customize your desktop experience with simple UI design philosophy in mind.
